...
export function MoviesList() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (
        ...
        fetchPopularMovies(currentPage + 1, false);
      }
    };
  ...
  const fetchPopularMovies = async (page = 1, isInitial = false) => {
    try {
      if (isInitial) {
        setLoading(true);
      } else {
      ...
      if (isInitial) {
        ...
        setMovies((prevMovies) => {
          ...
          // Filter out any movies that already exist
      ...
      <div className="w-full py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <button
              onClick={() => fetchPopularMovies(1, true)}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Discover the most popular movies trending today
          </p>
        </div>
          ...
          {!hasMorePages && movies.length > 0 && (
            <div className="mb-6">
              <p className="text-gray-400 text-lg mb-4">
                🎬 You've seen all {movies.length} popular movies!
              </p>
