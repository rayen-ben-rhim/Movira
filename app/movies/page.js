        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Explore our vast collection of popular movies, from the latest
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mt-12">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Popular Movies</div>
              </div>
              <div className="text-center">
...
export const metadata = {
  title: "Movies - Movira | Discover Popular Films",
  description:
    "Explore thousands of popular movies with Movira. Browse family-friendly films, blockbusters, and classics with detailed information and ratings.",
};
